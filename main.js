...
// Porcentajes originales de cada tema (en %)
...
// Fórmula: Nota_Tema = (Test Teórico * 0.16) + (Test Práctico * 0.24) + (Tareas * 0.60)
...
function calcularModulo() {
  ...
  // Se redistribuyen los pesos de los temas impartidos de forma proporcional.
  let notaModulo = 0;
